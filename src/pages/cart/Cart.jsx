    ...
    return(
        <div className='cart'>
                ...
                <div className='cart__details'>
                        <p><span><MdDiscount className='cart__couponlogo' /> have a coupon?</span> <button className='cart__coupon'>apply</button></p>
                        <hr />
                        <h2>PRICE DETAILS</h2>
                        <hr />
                        <p>
                        ...
                        <hr />
                        <p className='cart__message'>you will save &#8377;{totalDiscountedPrice} on this order</p>
